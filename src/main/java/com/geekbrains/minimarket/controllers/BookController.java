...
public class BookController {
    ...
    public ResponseEntity<?> createNewBooks(@RequestBody BookDto book) {
        if(book.getId() != null) {
        ...
        return new ResponseEntity<>(new BookDto(bookService.save(book)), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<?> modifyBook(@RequestBody BookDto b) {
        if(b.getId() == null) {
            return new ResponseEntity<>(new MarketError(HttpStatus.BAD_REQUEST.value(), "Id must be null for new entity!"), HttpStatus.BAD_REQUEST);
        ...
        return new ResponseEntity<>(new BookDto(bookService.save(b)), HttpStatus.OK);
    }
